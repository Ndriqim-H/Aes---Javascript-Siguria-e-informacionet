...
// let x = Aes.Ctr.encrypt('secret', 'password', 256); // encr: 'lwGl66VVwVObKIr6of8HVqJr'

// let y = Aes.Ctr.decrypt("ecde39d3982f", 'password========================', 256); // decr: 'big secret'
// console.log(x);
// console.log(y);
// console.log(Aes.Ctr.encrypt('Hello World', 'password', 256));